...
parser.add_argument('--loss_flag', type=int, default=0, help='loss function flag, 0 for MSE, 1 for MAE, 2 for both of MSE & MAE, 3 for SmoothL1loss')
...
parser.add_argument('--VAE_learning_rate', default=2e-3, type=float, help='VAE learning rate')
...
parser.add_argument('--save', type=str, default='ETTh2')  
parser.add_argument('--log_freq', default=200, type=int, help='num iterations per log')
parser.add_argument('--mean', type=float, default=0.9, help='Mean of Gaussian')
...
parser.add_argument('--aug_number', type=int, default=15, help='aug_number')
parser.add_argument('--aug1', type=str, default='na',
...
if args.online_method:
    ...
    if args.online_method == 'OneNet' and args.pretrain:
        ...
        args.fsnet_path = f'./checkpoints/{args.dataset}_60_{args.pred_len}_{fsnet_name}_' \
                          ...
                          f'_dm512_nh8_el2_dl1_df2048_fc3_ebtimeF_dtTrue_test_{0}/checkpoint.pth'
...
if __name__ == '__main__':
    ...
    for ii in range(args.itr):
        ...
        if args.border_type:
            ...
            fix_seed = 2021 + ii if args.model == 'iTransformer' else 2021 + ii
        setup_seed(fix_seed)
        print('Seed:', fix_seed)
        ...
        if args.online_method not in ['Online', 'SOLID', 'DERpp']:
    ...
    f = open("result.txt", 'a')
    f.write(setting + "  \n")
    f.write('mse:{}, mae:{}'.format(all_results['mse'], all_results['mae']))
    f.write('\n')
    f.write('\n')
    f.close()