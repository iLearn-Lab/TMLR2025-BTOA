...
do
  python -u run.py \
    ...
    --pct $pct \
    --patience 10 \
    --learning_rate $learning_rate >> ./logs/ETTh2/$model_name'_'$data'_'$pred_len'_lr'$learning_rate.log 2>&1
done
done
for pred_len in 48
do
...
do
  filename=logs/ETTh2/$model_name'_'$online_method'_'$data'_'$pred_len'_onlinelr'$online_learning_rate.log2
  python -u run.py \
    --dataset $data --bordBTOA_type 'online' \
    --model $model_name \
    --seq_len $seq_len \
